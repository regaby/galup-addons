...
to_19 = ( 'Cero',  'Uno',   'Dos',  'Tres', 'Cuatro',   'Cinco',   'Seis',
          'Siete', 'Ocho', 'Nueve', 'Diez',   'Eleven', 'Doce', 'Trece',
          'Catorce', 'Quince', 'Diesciseis', 'Diescisiete', 'Diesciocho', 'Diescinueve' )
tens  = ( 'Veinte', 'Treinta', 'Cuarenta', 'Cincuenta', 'Sesenta', 'Setenta', 'Ochenta', 'Noventa')
denom = ( '',
          'Mil',     'Millón',         'Billion',       'Trillion',       'Quadrillion',
...
def _convert_nnn(val):
    ...
    if rem > 0:
        if to_19[rem] == 'Uno':
            word = 'Ciento'
        elif to_19[rem] == 'Cinco':
            word = 'Quinientos'
        elif to_19[rem] == 'Nueve':
            word = 'Novecientos'
        else:
...
def amount_to_text(number, currency):
    ...
    return ' '.join(filter(None, [start_word, units_name, (start_word or units_name) and (end_word or cents_name) and 'con', end_word, cents_name]))
