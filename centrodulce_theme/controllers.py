...
class website_sale(http.Controller):
    ...
    def centrodulce_shop(self, page=0, category=None, search='', ppg=False, **post):
    ...
    @http.route('/page/aboutus', auth='public', website=True)
    def centrodulce_aboutus(self, page=0, category=None, search='', ppg=False, **post):
        cr, uid, context, pool = request.cr, request.uid, request.context, request.registry
    ...
    @http.route('/page/contactus', auth='public', website=True)
    def centrodulce_contactus(self, page=0, category=None, search='', ppg=False, **post):
        cr, uid, context, pool = request.cr, request.uid, request.context, request.registry
    ...
    def channel2(self, channel, category=None, tag=None, page=1, slide_type=None, sorting='creation', search=None, **kw):
        cr, uid, context, pool = request.cr, request.uid, request.context, request.registry
